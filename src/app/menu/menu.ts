...
//? DOC: http://localhost:7777/demo/arcana-angular-admin-dashboard-template/documentation/guide/development/navigation-menus.html#interface
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        translate: 'MENU.INVENTORY.SHORTAGE_PRODUCTS',
        type: 'item',
        // role: ['Admin'],
        icon: 'circle',
        url: 'inventory/shortage-products'
      }
    ]
  },
  {
    ...
    children: [
      {
        id: 'invoices',
        title: 'Invoices',
        translate: 'MENU.PURCHASE.INVOICES',
        type: 'item',
      ...
      },
      {
        ...
        id: 'suppliers',
        title: 'Suppliers',
        translate: 'MENU.PURCHASE.SUPPLIERS',
        type: 'item',
        // role: ['Admin'],
        icon: 'circle',
      ...
      },
      {
        ...
        translate: 'MENU.PURCHASE.RETURN',
        type: 'item',
        // role: ['Admin'],
        icon: 'circle',
        url: 'purchase/return'
      },
      {
        ...
        translate: 'MENU.PURCHASE.ORDERS',
        type: 'item',
        // role: ['Admin'],
        icon: 'circle',
        url: 'purchase/orders'
    ...
    children: [
      {
        id: 'account',
        title: 'Account',
        translate: 'MENU.ACCOUNTS.ACCOUNT',
        type: 'item',
        icon: 'circle',
      ...
      },
      {
        id: 'transaction',
        title: 'Transaction',
        translate: 'MENU.ACCOUNTS.TRANSACTION',
        type: 'item',
        icon: 'circle',
      ...
      },
      {
        id: 'trialBalance',
        title: 'Trial Balance',
        translate: 'MENU.ACCOUNTS.TRIAL_BALANCE',
        type: 'item',
        icon: 'circle',
      ...
      },
      {
        id: 'balanceSheet',
        title: 'Balance Sheet',
        translate: 'MENU.ACCOUNTS.BALANCE_SHEET',
        type: 'item',
        icon: 'circle',
      ...
      },
      {
        ...
        translate: 'MENU.ACCOUNTS.INCOME_STATEMENT',
        type: 'item',
        icon: 'circle',
    ...
    children: [
      {
        ...
        translate: 'MENU.REPORT.INVENTORY_REPORT',
        type: 'item',
        icon: 'circle',
      ...
      },
      {
        ...
        translate: 'MENU.REPORT.PURCHASE_REPORT',
        type: 'item',
        icon: 'circle',
      ...
      },
      {
        id: 'saleReport',
        title: 'Sale Report',
        translate: 'MENU.REPORT.SALE_REPORT',
        type: 'item',
        icon: 'circle',
      ...
      },
      {
        ...
        translate: 'MENU.REPORT.SUPPLIER_REPORT',
        type: 'item',
        icon: 'circle',
      ...
      },
      {
        ...
        translate: 'MENU.REPORT.CUSTOMER_REPORT',
        type: 'item',
        icon: 'circle',
      ...
      },
      {
        ...
        translate: 'MENU.REPORT.PAYMENT_REPORT',
        type: 'item',
        icon: 'circle',
    ...
    children: [
      {
        ...
        icon: 'book',
        type: 'item',
        url: 'https://sianca.com.ar/arcana/documentation',
        externalUrl: true,
        openInNewTab: true
      },
      {
